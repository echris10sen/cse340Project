...
-- ***NOTICE*** CHANGE THE VARIABLE AFTER "OWNER TO" TO THE USERNAME PROVIDED BY THE DATABASE!!!
ALTER TYPE public.account_type OWNER TO cse340_jazz_user;
